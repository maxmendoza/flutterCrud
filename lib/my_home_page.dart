...
class _MyHomePage extends State<MyHomePage> {
  List<Client> clients = [
    Client(name: 'Cruze', surname: '2019', phone: '302 454 25 93'),
    Client(name: 'Aveo', surname: '2013', phone: '322 412 34 68'),
    Client(name: 'Camaro', surname: '2023', phone: '301 441 36 98'),
    Client(name: 'Matiz', surname: '2010', phone: '310 789 90 62')
  ];
